...
class DetailsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('details')->insert([
            ...
            [
                'book_id' => '2',
                'author' => 'Angel Setiadi',
                'publisher' => 'ANN Publishing',
                'year' => '2001',
